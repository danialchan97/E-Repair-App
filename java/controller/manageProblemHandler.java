 ...
 * @author user
 */
public class manageProblemHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            output += "<thead><tr><th> Issue ID </th><th> Issue Details </th><th> Price </th><th> Update </th> </tr></thead><tbody>";
            ...
            try{
                ...
                out.println(output);
                    ...
                    Logger.getLogger(manageProblemHandler.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            {
                int problemID = Integer.parseInt(request.getParameter("issueID"));
                //out.print(problemID);
                Issue P = new Issue();
                
                P = P.getIssue(problemID);
